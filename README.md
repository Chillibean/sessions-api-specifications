...
8. Once Pull Request is in ready to review state, a pre-release is generated and `sessions-api-client-sdk` repository is tiggered to generate a new SDK package. Package version follows development branch version number + build run number, eg. **`1.0.11-dev.5`**.
...
You can access the documentation at [https://chillibean.github.io/sessions-api-specifications](https://chillibean.github.io/sessions-api-specifications).

The OpenAPI JSON file is available at [https://chillibean.github.io/sessions-api-specifications/fullSchema.json](https://chillibean.github.io/sessions-api-specifications/fullSchema.json).
